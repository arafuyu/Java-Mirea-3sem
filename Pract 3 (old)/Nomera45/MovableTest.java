...
public class MovableTest {
    public static void main(String[] args) {
        ...
        System.out.println("\nИзменение скорости для Rectangle:");
        System.out.println();
        MovableRectangle r = (MovableRectangle)m;
        r.setSpeed(10, 0); // меняет скорость только в верхней левой точке.
        try{                               // метод try, catch и throw для проверки на одиковость скоростей
            r.moveDown();
        }catch (IllegalStateException smert){
