...
public class Game {
    ...
    public static void main(String[] args) {
        System.out.println(new Pract7.n3.Game("85296", "04721").play());
        System.out.println(new Pract7.n3.Game("12345", "67890").play());
        System.out.println(new Pract7.n3.Game("13029", "42685").play());
    }
}